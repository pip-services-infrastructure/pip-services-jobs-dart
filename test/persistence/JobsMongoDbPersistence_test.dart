...
void main() {
  group('JobsMongoDbPersistence', () {
    JobsMongoDbPersistence persistence;
    ...
    setUp(() async {
      ...
      var mongoCollection = Platform.environment['MONGO_COLLECTION'] ?? 'jobs';
      ...
      persistence = JobsMongoDbPersistence();
